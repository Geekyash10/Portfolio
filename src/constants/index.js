...
const services = [
  {
    ...
    icon: backend,
    description: "I am passionate about writing clean and efficient code to create scalable and secure web applications that deliver exceptional performance and user experiences."
  },
  {
    title: "MERN Stack Developer",
    icon: web,
    description: "I thrive on building robust web applications using the MongoDB, Express.js, React, and Node.js , employing my skills  to deliver scalable and efficient solutions."
  },
  {
    title: "Frontend Developer",
    icon: mobile,
    description: "As a frontend developer, I excel at creating engaging  user interfaces, combining aesthetics with functionality to deliver seamless web experiences."
  },
];
...
const projects = [
 ...
 "JSCOP 6.0 is the flagship event for the JIIT Optica Chapter, designed to manage registrations and showcase the various events during the two-day festival. The website provides seamless registration for participants and gives a detailed overview of the events, making it easier for attendees to navigate and participate",
    ...
    source_code_link: "https://github.com/jiitopticachapter/JSCOP-6.0-Website",
  },
