		...
		<>
			...
			<div className="w-full flex">
				...
				>
					...
					described with links to code repositories and live demos. It
			...
			<div className="flex justify-center mt-10">
				<button
					...
					className="bg-tertiary my-4 py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary"
				>
					View All Projects
				</button>
			</div>
